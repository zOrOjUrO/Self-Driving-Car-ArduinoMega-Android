# Self-Driving Car - Car Navigator App
...
*Note: The Android Codes may not fully correspond to the complete app as we are uploading an old project and few files might be missing.*

***Hint: Just add and manage the mapbox depencies and the icon files (any) and you'll be good to go ;)***